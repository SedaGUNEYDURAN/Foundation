...
## Queue
• Stack gibidir, rastgele elemanlara erişemezsin. Yalnızca iki işlem vardır; kuyruğa alma(enqueue) ve kuyruktan çıkarma(dequeue). Listeye iki öğe eklersek ilk eklediğimiz son eklediğimizden önce çıkar; FIFO(First in First out) prensibi ile çalışır. . poll() metodu kuyruktaki en alttaki öğeyi yani en önce giren ögeyi döndürür ve sile. Kuyruk boş olduğunda bir exception fırlatmaz, null değeri döndürür.  
